...
description: "Use Thred MCP tools to retrieve transcripts and buyer insights in MCP clients."
icon: "robot"
---

Thred MCP Server lets MCP clients (Cursor, Claude Desktop, and others) query customer conversations and insights from your Thred workspace.
